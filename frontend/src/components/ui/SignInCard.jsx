import React, { useState } from 'react'; // Re-trigger HMR
...
export function SignInCard({ username, password, onUsernameChange, onPasswordChange, onSubmit, loading, error }) {
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
                            ...
                            <div className="text-center space-y-1 mb-5">
                                ...
                                >
                                    <span className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-b from-white to-white/70">W</span>
